...
2. Coarsen the L0 grid :math:`n-1` times using ``cgns_utils coarsen``. This may entail coarsening a surface mesh and extruding the family of surface meshes with ``pyhyp``.
