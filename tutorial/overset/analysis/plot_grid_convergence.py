...
data = {
    'ADflow': {
        ...
        'C_L': np.array([0.26064807, 0.26815573, 0.27296436]),
        'C_D': np.array([0.01879813, 0.01703536, 0.01654656]),
        'C_Dp': np.array([0.01326940, 0.01180256, 0.01173745]),
        'C_Dv': np.array([0.00552873, 0.00523279, 0.00480911]),
        'C_M': np.array([-0.18639411, -0.19025530, -0.19483153])
    },
